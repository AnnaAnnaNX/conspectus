...
import { fragmentFromString, selectDiv } from "@/tests/selection/selection";
...
describe("selectDiv", () => {
  it("II", async () => {
    ...
    await fs.writeFileSync('./realOutputHTML.txt', realOutputHTML as string)
    await fs.writeFileSync('./outputHTML.txt', outputHTML)
    // compare
